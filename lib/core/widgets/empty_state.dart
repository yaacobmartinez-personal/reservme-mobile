...
/// Centered illustration (or an icon on a pine-soft disc) + title + optional hint
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget visual = asset != null
        ...
        : Container(
            width: 88,
            height: 88,
            decoration: BoxDecoration(color: p.pineSoft, borderRadius: BorderRadius.circular(20)),
            child: Icon(icon, size: 38, color: p.pineInk),
          );
    if (animate) {
      visual = visual
        ...
        child: Column(
          ...
          children: [
            ...
            if (hint != null) ...[
              ...
              Text(hint!, textAlign: TextAlign.center, style: AppType.bodyS.copyWith(color: p.ink2)),
            ],
